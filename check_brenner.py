...
if __name__ == "__main__":
    BlurDetection = BlurDetection(strDir="/home/wangzj/WORK/shuibiao/data_shuibiao/shuibiao_labelEdit/difficult_samples/")
    resu = BlurDetection.Test_Tenengrad () # TestSMD
    print(resu)
